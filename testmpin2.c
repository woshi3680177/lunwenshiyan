...
int main()
{
  ...
  for(int TIM=100;TIM>1;TIM--) {
...
#endif
    unsigned long ran;
    char x[PGS], s[PGS], y[PGS], client_id[100], raw[100], sst[4 * PFS], token[2 * PFS + 1], sec[2 * PFS + 1], permit[
            2 * PFS + 1], xcid[2 * PFS + 1], xid[2 * PFS + 1], e[12 * PFS], f[12 * PFS];
    ...
    OCT_jstring(&CLIENT_ID, "910972029@qq.com");
